  ...
  (function() {
    ...
    function _visuallySort(a2, b2) {
      ...
      for (var _i7 = 0; _i7 < length; _i7++) {
        ...
        if (b2._stackingOrder[_i7].value > a2._stackingOrder[_i7].value) {
          return 1;
        }
        if (b2._stackingOrder[_i7].value < a2._stackingOrder[_i7].value) {
          return -1;
    ...
    function accessibleTextVirtual(virtualNode) {
      ...
      var computationSteps = [ arialabelledby_text_default, _arialabelText, native_text_alternative_default, form_control_value_default, subtree_text_default, textNodeValue, title_text_default ];
    ...
    function ariaConditionalRowAttr(node) {
      ...
      var _ref94 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}, invalidTableRowAttrs = _ref94.invalidTableRowAttrs;
      var virtualNode = arguments.length > 2 ? arguments[2] : undefined;
    ...
    function ariaRequiredChildrenEvaluate(node, options, virtualNode) {
      ...
      var unallowed = ownedRoles.filter(function(_ref95) {
        var role2 = _ref95.role;
        return !required.includes(role2);
      });
      if (unallowed.length) {
        this.relatedNodes(unallowed.map(function(_ref96) {
          var ownedElement = _ref96.ownedElement;
          return ownedElement;
        }));
        this.data({
          messageKey: 'unallowed',
          values: unallowed.map(function(_ref97) {
            var ownedElement = _ref97.ownedElement, attr = _ref97.attr;
    ...
    function missingRequiredChildren(virtualNode, role, required, ownedRoles) {
      var _loop8 = function _loop8(_i30) {
        var role2 = ownedRoles[_i30].role;
    ...
    function getTextShadowColors(node) {
      var _ref98 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}, minRatio = _ref98.minRatio, maxRatio = _ref98.maxRatio;
      var style = window.getComputedStyle(node);
      ...
      shadows.forEach(function(_ref99) {
        var colorStr = _ref99.colorStr, pixels = _ref99.pixels;
    ...
    function textShadowColor(_ref100) {
      var colorStr = _ref100.colorStr, offsetX = _ref100.offsetX, offsetY = _ref100.offsetY, blurRadius = _ref100.blurRadius, fontSize = _ref100.fontSize;
    ...
    function _getStackingContext(elm, elmStack) {
      ...
      elmStack.forEach(function(bgElm) {
        ...
        var stackingOrder = bgVNode._stackingOrder.filter(function(_ref101) {
          var vNode2 = _ref101.vNode;
          return !!vNode2;
        });
        stackingOrder.forEach(function(_ref102, index) {
          var _stackingOrder;
          var vNode2 = _ref102.vNode;
    ...
    function getStrokeColor(nodeStyle, _ref103) {
      var _ref103$textStrokeEmM = _ref103.textStrokeEmMin, textStrokeEmMin = _ref103$textStrokeEmM === void 0 ? 0 : _ref103$textStrokeEmM;
    ...
    function colorContrastEvaluate(node, options, virtualNode) {
      ...
      var _ref104 = isSmallFont ? contrastRatio.normal : contrastRatio.large, expected = _ref104.expected, minThreshold = _ref104.minThreshold, maxThreshold = _ref104.maxThreshold;
    ...
    function findPseudoElement(vNode, _ref105) {
      var _ref105$pseudoSizeThr = _ref105.pseudoSizeThreshold, pseudoSizeThreshold = _ref105$pseudoSizeThr === void 0 ? .25 : _ref105$pseudoSizeThr, _ref105$ignorePseudo = _ref105.ignorePseudo, ignorePseudo = _ref105$ignorePseudo === void 0 ? false : _ref105$ignorePseudo;
      if (ignorePseudo) {
        return;
      }
      var rect = vNode.boundingClientRect;
    ...
    function parseUnit(str) {
      ...
      var _ref106 = str.match(unitRegex) || [], _ref107 = _slicedToArray(_ref106, 3), _ref107$ = _ref107[1], value = _ref107$ === void 0 ? '' : _ref107$, _ref107$2 = _ref107[2], unit = _ref107$2 === void 0 ? '' : _ref107$2;
      return {
    ...
    function focusableModalOpenEvaluate(node, options, virtualNode) {
      var tabbableElements = virtualNode.tabbableElements.map(function(_ref108) {
    ...
    function getInvalidSelector(vChild, nested, _ref109) {
      var _ref109$validRoles = _ref109.validRoles, validRoles = _ref109$validRoles === void 0 ? [] : _ref109$validRoles, _ref109$validNodeName = _ref109.validNodeNames, validNodeNames = _ref109$validNodeName === void 0 ? [] : _ref109$validNodeName;
    ...
    function cssOrientationLockEvaluate(node, options, virtualNode, context) {
      var _ref110 = context || {}, _ref110$cssom = _ref110.cssom, cssom = _ref110$cssom === void 0 ? void 0 : _ref110$cssom;
      var _ref111 = options || {}, _ref111$degreeThresho = _ref111.degreeThreshold, degreeThreshold = _ref111$degreeThresho === void 0 ? 0 : _ref111$degreeThresho;
      ...
      var _loop9 = function _loop9() {
        ...
        orientationRules.forEach(function(_ref112) {
          var cssRules = _ref112.cssRules;
      ...
      function groupCssomByDocument(cssObjectModel) {
        return cssObjectModel.reduce(function(out, _ref113) {
          var sheet = _ref113.sheet, root = _ref113.root, shadowId = _ref113.shadowId;
      ...
      function isMediaRuleWithOrientation(_ref114) {
        var type2 = _ref114.type, cssText = _ref114.cssText;
        if (type2 !== 4) {
          return false;
        }
        return /orientation:\s*landscape/i.test(cssText) || /orientation:\s*portrait/i.test(cssText);
      }
      function getIsOrientationLocked(_ref115) {
        var selectorText = _ref115.selectorText, style = _ref115.style;
      ...
      function getAngleInDegrees(angleWithUnit) {
        var _ref116 = angleWithUnit.match(/(deg|grad|rad|turn)/) || [], _ref117 = _slicedToArray(_ref116, 1), unit = _ref117[0];
        if (!unit) {
          return 0;
        }
    ...
    function getLargestUnobscuredArea(vNode, obscuredNodes) {
      ...
      var obscuringRects = obscuredNodes.map(function(_ref120) {
        var rect = _ref120.boundingClientRect;
        return rect;
      });
    ...
    function rectHasMinimumSize(minSize, _ref121) {
      var width = _ref121.width, height = _ref121.height;
    ...
    function getHeadingOrder(results) {
      ...
      results.sort(function(_ref123, _ref124) {
        var nodeA = _ref123.node;
        var nodeB = _ref124.node;
        return nodeA.ancestry.length - nodeB.ancestry.length;
      });
      var headingOrder = results.reduce(mergeHeadingOrder, []);
      return headingOrder.filter(function(_ref125) {
        var level = _ref125.level;
        return level !== -1;
      });
    }
    ...
    function getLevel(vNode) {
      ...
      var ariaLevel = parseInt(ariaHeadingLevel, 10);
      var _ref126 = vNode.props.nodeName.match(/h(\d)/) || [], _ref127 = _slicedToArray(_ref126, 2), headingLevel = _ref127[1];
      if (!headingRole) {
        return -1;
      }
    ...
    function identicalLinksSamePurposeAfter(results) {
      ...
      var incompleteResults = results.filter(function(_ref128) {
        var result = _ref128.result;
    ...
    function metaRefreshEvaluate(node, options, virtualNode) {
      var _ref131 = options || {}, minDelay = _ref131.minDelay, maxDelay = _ref131.maxDelay;
    ...
    function findRegionlessElms(virtualNode, options) {
      ...
      if (get_role_default(virtualNode) === 'button' || isRegion(virtualNode, options) || [ 'iframe', 'frame' ].includes(virtualNode.props.nodeName) || _isSkipLink(virtualNode.actualNode) && get_element_by_reference_default(virtualNode.actualNode, 'href') || !_isVisibleToScreenReaders(node)) {
        ...
        return virtualNode.children.filter(function(_ref132) {
    ...
    function getNumberValue(domNode, _ref133) {
      var cssProperty = _ref133.cssProperty, absoluteValues = _ref133.absoluteValues, normalValue = _ref133.normalValue;
    ...
    function svgNonEmptyTitleEvaluate(node, options, virtualNode) {
      ...
      var titleNode = virtualNode.children.find(function(_ref134) {
    ...
    function noExplicitNameRequired(node, virtualNode) {
      ...
      var _ref135 = aria_roles_default[role] || {}, accessibleNameRequired = _ref135.accessibleNameRequired;
